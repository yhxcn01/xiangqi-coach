...
搜索深度可在设置中调节（深度 2~7）：深度越高棋力越强、耗时越长；开局阶段深度 7 约 6 秒，中局可能 30 秒以上。

### 字体说明

棋子文字使用 [霞鹜文楷](https://github.com/lxgw/LxgwWenKai)（SIL Open Font License）子集字体 `docs/fonts/qizi.woff2`（仅含 11 个棋子字，3.4KB），保证所有设备字形完全一致。
